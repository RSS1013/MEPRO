...
public record Carta(int clave, Palo palo, int puntuacion){
	...
	/** Texto asociado a las puntuaciones. */
	private static final String[] CARTAS = { "<No definido>", "As", "Dos", "Tres", "Cuatro", "Cinco", "Seis", "Siete", "Sota", "Caballo",
	"Rey" };
	 ...
	 */
	private static String traducir(final int puntuacion) {
